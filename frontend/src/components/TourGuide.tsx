    ...
    for (const p of visiblePlatforms) {
      if (p.id === "deliverables") {
        s.push({
          ...
          content: "Manage your monthly deliverables here. Track overall completion with the progress bar, check off individual tasks with auto-save, and submit change requests — all in one place.",
          placement: "bottom",
          skipBeacon: true,
          closeButtonAction: "skip" as const,
