            ...
            {igTopPost ? (
              <div className="border border-gray-100 rounded-2xl p-5 bg-gray-50/50 space-y-3">
                ...
                <div className="flex gap-4">
                  {igTopPost.media_url && (
                    <img src={igTopPost.media_url} alt="Top Post" className="w-20 h-20 rounded-xl object-cover border border-gray-200 shrink-0" />
                  )}
          ...
          <div className="space-y-6">
            ...
            {fbTopPost ? (
              <div className="border border-gray-100 rounded-2xl p-5 bg-gray-50/50 space-y-3">
                ...
                <div className="flex gap-4">
                  {fbTopPost.media_url && (
                    <img src={fbTopPost.media_url} alt="Top Post" className="w-20 h-20 rounded-xl object-cover border border-gray-200 shrink-0" />
                  )}
                  <div className="space-y-2 flex-1">
                    <p className="text-xs text-gray-600 font-medium leading-relaxed line-clamp-2 italic">
